...
import { CreateUserRequest, UserListItem, Users } from '../../shared/models/users';
...
export class UsersService {
  ...
  private baseURL = `${apiUrl()}/api/v1/users`;
  ...
  public getProfile(): Observable<Profile> {
    return this.httpClient.get<Profile>(`${apiUrl()}/api/v1/profile`);
  }
