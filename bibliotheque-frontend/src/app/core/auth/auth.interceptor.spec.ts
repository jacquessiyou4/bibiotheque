...
describe('AuthInterceptor', () => {
  ...
  beforeEach(() => {
    ...
    interceptor = new AuthInterceptor(userAuthService, router, notificationService, TestBed.inject(TranslationService));
  ...
  it('redirige vers /login sur une erreur 401', () => {
    ...
    interceptor.intercept(new HttpRequest('GET', '/profile'), handler).subscribe({
      error: () => undefined
    });
