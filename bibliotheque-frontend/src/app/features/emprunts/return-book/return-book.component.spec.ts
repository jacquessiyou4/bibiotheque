...
describe('ReturnBookComponent', () => {
  ...
  const mockBorrows: Borrow[] = [
    { borrowId: 7, bookId: 3, userId: 1, issueDate: '2026-09-01T10:00:00', returnDate: null, dueDate: '2026-09-08T10:00:00' },
  ];
  ...
  it('returnBook envoie le borrowId au service', () => {
    borrowServiceSpy.returnBook.and.returnValue(of(mockBorrows[0]));

    component.returnBook(7);

    expect(borrowServiceSpy.returnBook).toHaveBeenCalledWith(7);
  });

  it('affiche les dates ISO en jj/mm/aaaa', () => {
